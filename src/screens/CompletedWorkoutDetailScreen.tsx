...
export const CompletedWorkoutDetailScreen = ({ navigation }: any) => {
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Upper Body Hypertrophy</Text>
        <View style={styles.dateRow}>
          <Text style={styles.dateIcon}>📅</Text>
          <Text style={styles.dateText}>Sunday, March 5, 2026</Text>
        </View>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.statsRow}>
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>58 min</Text>
        ...
        {mockCompletedExercises.map((exercise, index) => (
          <View key={exercise.id} style={styles.exerciseCard}>
            <View style={styles.exHeader}>
              ...
              <View style={styles.exIcons}>
                <Info size={16} color="#3B82F6" style={styles.iconSpaced} />
                <TrendingUp size={16} color="#A855F7" style={styles.iconSpaced} />
                <Medal size={16} color="#EAB308" style={styles.iconSpaced} />
            ...
            {exercise.sets.map((set, i) => (
              <View key={i} style={styles.tableRow}>
                <Text style={[styles.tdText, { flex: 0.5, fontWeight: '700' }]}>{set.set}</Text>
                <Text style={[styles.tdText, { flex: 1, textAlign: 'center' }]}>{set.weight}</Text>
